...
/**
 * @file mock_Esys_Clear.h
 * @brief Header declaring a mock function for Esys_Clear().
 */
#ifndef __MOCK_ESYS_CLEAR_H__
#define __MOCK_ESYS_CLEAR_H__

#include <tss2/tss2_common.h>
#include <tss2/tss2_esys.h>

/**
 * Mock function for Esys_Clear().
 *
