 ...
 *
 * If cominitMockFreeEnabled is true then it checks that the right parameters are
 * given.
 * If cominitMockFreeEnabled is false then the call is forwarded to the genuine free
 * method.
 */
 ...
 */
extern bool cominitMockFreeEnabled;
