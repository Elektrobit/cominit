 ...
 *
 * If cominitMockMallocEnabled is true then it checks that the right parameters are given
 * and return a preset pointer.
 * If cominitMockMallocEnabled is false then the call is forwarded to the genuine free
 * method.
 */
 ...
 */
extern bool cominitMockMallocEnabled;
